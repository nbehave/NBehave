    ...
    public class ActionStepParser
    {
        ...
        private ActionMethodInfo BuildActionMethodInfo(ActionStepAttribute actionStep, MethodInfo method)
        {
            if (actionStep.ActionMatch == null)
            {
                ...
                return new ActionMethodInfo
                {
                    ActionType = tokenString.GetFirstWord(),
                    MethodInfo = method,
                    ActionStepMatcher = actionMatcher
                };
            }

            return new ActionMethodInfo
                    {
                        ActionType = actionStep.Type,
                        MethodInfo = method,
                        ActionStepMatcher = actionStep.ActionMatch
                    };
        }
