...
namespace NBehave.Narrator.Framework.Specifications
{
	...
	{
		private StringStepRunner _runner;
		...
		public class When_running_plain_text_scenarios : StringStepRunnerSpec
		{
			...
			public void Should_invoke_action_given_a_token_string()
			{
				...
				_runner.InvokeStringStep(new ActionStepText("my name is Morgan",""));
			...
			{
				_runner.InvokeStringStep(new ActionStepText("This doesnt exist",""));
			}
		}
