...
{
    public abstract class MbUnit_ScenarioDrivenSpecBaseSpecs : MbUnit.ScenarioDrivenSpecBase
    {
        [TestFixture]
        public class ScenarioDrivenSpecBaseSpecs : MbUnit_ScenarioDrivenSpecBaseSpecs
        {
